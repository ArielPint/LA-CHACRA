-- Migración 032: Materiales (100101/100132/100703/101204) pasa a costearse
-- por fecha de OC en vez de fecha de factura. Motivo: las compras de
-- materiales fluyen por registro-gd (OC + guía), no por la pestaña Facturas —
-- casi nunca tienen una factura cargada en financiero_facturas, por eso
-- Materiales daba $0 en meses con compras reales (ej. febrero 2026). El resto
-- de las categorías (subcontratos, gastos operacionales/generales) sigue por
-- fecha de factura: ahí sí se carga factura normalmente, y usar fecha de OC
-- las infla (un solo contrato grande cae entero en el mes en que se emitió
-- la OC — el problema que se corrigió en la migración 030 para Mano de Obra).
